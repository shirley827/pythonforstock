...
q = np.percentile(simulations,1) #percentile value search for the right number for montecarlo monitor

plt.hist(simulations,bins=200) #for drawing a Histogram using 200 (can be changed) blocks to show the shape of the numbers


plt.axvline(x=q,linewidth=4,color="r")

plt.title(u"Final price distribution for CMB stock after %s days" %days,weight="bold")
